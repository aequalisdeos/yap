...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_move = 27,                      /* move  */
  YYSYMBOL_argyment = 28,                  /* argyment  */
  YYSYMBOL_base = 29,                      /* base  */
  YYSYMBOL_operation = 30,                 /* operation  */
  YYSYMBOL_lenth = 31                      /* lenth  */
};
...
{
       0,    57,    57,    58,    60,    61,    62,    63,    65,    67,
      69,    70,    71,    72,    74,    76,    78,    79,    81
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "OB", "CB", "FCB",
  "FOB", "COMMA", "SEMICOLON", "IF", "ELSE", "WHILE", "AREA", "IS",
  "CLEAR", "UP", "DOWN", "LEFT", "RIGHT", "PAINT", "NOTHING", "NUMBER",
  "$accept", "commands", "command", "else", "condition", "move",
  "argyment", "base", "operation", "lenth", YY_NULLPTR
};
...
{
     -27,     0,   -27,     4,     5,   -27,   -27,   -27,   -27,   -27,
       7,   -27,     8,     8,    -7,   -27,     6,    17,    18,   -27,
     -27,    16,    10,    19,    20,     9,   -12,   -12,   -12,   -27,
      23,   -27,    24,    26,    25,    22,   -27,   -27,    28,   -27,
     -12,    30,   -27
};
...
{
       2,     0,     1,     0,     0,    10,    11,    13,    12,     3,
       0,     7,     0,     0,     0,    14,     0,     0,     0,    17,
      16,     0,     0,     0,     0,     0,     0,     0,     0,    18,
       0,     9,     0,     0,     0,     5,     6,    15,     0,     4,
       0,     0,     8
};
...
{
     -27,   -27,   -27,   -27,    15,    11,   -26,   -27,   -27,   -27
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     1,     9,    39,    17,    10,    11,    15,    21,    30
};
...
{
       2,    32,    33,     5,     6,     7,     8,    12,    13,     3,
      14,     4,    19,    20,    41,     5,     6,     7,     8,    22,
      16,    23,    24,    25,    26,    27,    28,    34,    18,    35,
      29,    36,    38,    37,    40,    42,     0,    31
};

static const yytype_int8 yycheck[] =
{
       0,    27,    28,    15,    16,    17,    18,     3,     3,     9,
       3,    11,    19,    20,    40,    15,    16,    17,    18,    13,
      12,     4,     4,     7,    14,     6,     6,     4,    13,     5,
      21,     5,    10,     8,     6,     5,    -1,    26
};
...
{
       0,    23,     0,     9,    11,    15,    16,    17,    18,    24,
      27,    28,     3,     3,     3,    29,    12,    26,    26,    19,
      20,    30,    13,     4,     4,     7,    14,     6,     6,    21,
      31,    27,    28,    28,     4,     5,     5,     8,    10,    25,
       6,    28,     5
};
...
#line 1146 "parser.tab.c"
  ...
  case 4: /* command: IF OB condition CB FOB argyment FCB else  */
#line 60 "parser.y"
                                                  { (yyval.a) = newFlow('I', (yyvsp[-5].a), (yyvsp[-2].a), (yyvsp[0].a)); }
#line 1152 "parser.tab.c"
    break;

  case 5: /* command: IF OB condition CB FOB argyment FCB  */
#line 61 "parser.y"
                                      { (yyval.a) = newFlow('I', (yyvsp[-4].a), (yyvsp[-1].a), NULL);  }
#line 1158 "parser.tab.c"
    break;

  case 6: /* command: WHILE OB condition CB FOB argyment FCB  */
#line 62 "parser.y"
                                         { (yyval.a) = newFlow('W', (yyvsp[-4].a), (yyvsp[-1].a), NULL);  }
#line 1164 "parser.tab.c"
    break;

  case 7: /* command: argyment  */
#line 63 "parser.y"
           { (yyval.a) = newAst('a', (yyvsp[0].a), NULL); }
#line 1170 "parser.tab.c"
    break;

  case 8: /* else: ELSE FOB argyment FCB  */
#line 65 "parser.y"
                            { (yyval.a) = newAst('e', (yyvsp[-1].a), NULL); }
#line 1176 "parser.tab.c"
    break;

  case 9: /* condition: AREA IS CLEAR move  */
#line 67 "parser.y"
                              { (yyval.a) = newAst('c', (yyvsp[0].a), NULL); }
...
#line 1206 "parser.tab.c"
  ...
  case 14: /* argyment: move base  */
#line 74 "parser.y"
                    { (yyval.a) = newAst('m', (yyvsp[-1].a), (yyvsp[0].a)); }
#line 1212 "parser.tab.c"
    break;

  case 15: /* base: OB operation COMMA lenth CB SEMICOLON  */
#line 76 "parser.y"
                                            { (yyval.a) = newAst('b', (yyvsp[-4].a), (yyvsp[-2].a)); }
#line 1218 "parser.tab.c"
    break;

  case 16: /* operation: NOTHING  */
#line 78 "parser.y"
                   { (yyval.a) = newAst('n', NULL, NULL);  }
#line 1224 "parser.tab.c"
    break;

  case 17: /* operation: PAINT  */
#line 79 "parser.y"
        { (yyval.a) = newAst('p', NULL, NULL);  }
#line 1230 "parser.tab.c"
    break;

  case 18: /* lenth: NUMBER  */
#line 81 "parser.y"
              { (yyval.a) = newNum((yyvsp[0].number)); }
